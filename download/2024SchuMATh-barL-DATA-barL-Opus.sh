#!/bin/bash
# Downloading German variety data from various sources via OpusTools
# Language Codes on https://opus.nlpl.eu/
# German - de               German (Germany) - de-DE    
# Bavarian - bar            Swabian - swg           Low German - nds    Low Saxon - nds-nl
# Western Frisian - fy      Lower Sorbian - dsb     Upper Sorbian - hsb
# Swiss High German - de-CH Austrian German - de-AT Walser - wae
# Germanic: Danish - da     Danish (Denmark) - da-DK    Dutch - nl      Dutch (Netherlands) - nl-NL
# Luxembourgish - lb    Limburgish - li

###############################################################################
# Find corpora for a language
source /media/AllBlue/LanguageData/TOOLS/vOpusTools/bin/activate

# for SOURCE in bar swg nds nds_nl; do
#     echo "${SOURCE}"
...
###############################################################################
# Download data for language pairs via script
for SOURCE in bar swg nds nds_nl fy de_CH de_AT wae lb li; do
    for TARGET in de; do
