...
trg_train = f'{prep_dir}/train.{trg_l}u'
...
experiment_dir = "/media/AllBlue/LanguageData/EXPERIMENT/2024SchuMATh-barL-SYNT-mult-Opus-0001/Perturbed/Medium"
src_train_out = f'{experiment_dir}/train.{src_l}'
trg_train_out = f'{experiment_dir}/train.{trg_l}u'
src_dev_out =  f'{experiment_dir}/dev.{src_l}'
src_test_out =  f'{experiment_dir}/test.{src_l}'
trg_dev_out =  f'{experiment_dir}/dev.{trg_l}u'
trg_test_out =  f'{experiment_dir}/test.{trg_l}u'
